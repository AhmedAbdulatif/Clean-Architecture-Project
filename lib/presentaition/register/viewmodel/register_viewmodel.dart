...
import 'package:clean_arc_app/domain/usecase/register_usecase.dart';
import 'package:clean_arc_app/presentaition/base/base_viewmodel.dart';
import 'package:clean_arc_app/presentaition/common/freezed_data_classes.dart';
...
class RegisterViewModel extends BaseViewModel
  ...
  Stream<bool> get outputIsEmailValid =>
      emailStreamController.stream.map((email) => checkEmail(email));
  @override
